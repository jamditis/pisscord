 ...
 * Void/Cyberpunk themed login with Email Link and Google Sign-In
 */
...
export const LoginScreen: React.FC<LoginScreenProps> = ({ error: authError }) => {
    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
          ...
          {emailSent ? (
            ...
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 px-4 rounded-xl bg-white text-gray-800 font-medium flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-6"
              >
              ...
              <form onSubmit={handleEmailSubmit}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    disabled={loading}
                    className="w-full px-4 py-3 rounded-xl bg-black/30 border border-gray-700 text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500 transition-colors disabled:opacity-50"
                  />
                </div>
              ...
              {error && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="mt-4 p-3 rounded-lg bg-red-500/20 border border-red-500/30 text-red-400 text-sm"
                >
                  {error}
                </motion.div>
              )}
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          Private family server. Invitation only.
        </p>
      </motion.div>
    </div>
  );
