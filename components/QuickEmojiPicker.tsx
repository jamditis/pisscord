        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 z-[101] rounded-t-3xl overflow-hidden max-h-[70vh]"
              style={{
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute bottom-full right-0 mb-2 z-[100] rounded-lg overflow-hidden shadow-xl w-80"
          style={{
